...
#
    ...
    tensor_rt_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[realsense_camera_node,image_format_converter_node,resize_node, encoder_node, tensor_rt_node, yolov8_decoder_node,visual_slam_node],
        output='screen',
